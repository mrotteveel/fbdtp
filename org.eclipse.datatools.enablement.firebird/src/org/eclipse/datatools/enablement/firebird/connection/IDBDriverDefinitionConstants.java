...
public interface IDBDriverDefinitionConstants {
	...
	/**
	 * Property used to store the DB version. This property is used in resolving
	 * the dbdefinition referenced by the driver.
	 */
	...
	/**
	 * Property used to store the default user name. This property is used the
	 * generic DB connection profile wizard during initialization. This property
	 * is also used by the DB connection profile.
	 */
	public static final String USERNAME_PROP_ID = PROP_PREFIX + "username"; //$NON-NLS-1$

	/**
	 * Property used to store the default password. This property is used the
	 * generic DB connection profile wizard during initialization. This property
	 * is also used by the DB connection profile.
	 */
